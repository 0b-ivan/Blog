...
function buildEditorialCoverSvg(post, imageDataUri = '') {
  ...
  const imageMarkup = imageDataUri
    ? `<image href="${imageDataUri}" x="470" y="1270" width="1130" height="1290" opacity="0.82" preserveAspectRatio="xMidYMid slice" clip-path="url(#imageClip)"/>`
    : '';
  ...
  <defs>
    ...
    <linearGradient id="imageFade" x1="0" y1="0" x2="1" y2="1">
      ...
      <stop offset="0.4" stop-color="#ffffff" stop-opacity="0.34"/>
