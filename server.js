...
function recoverMetadata(raw, parsed) {
  const fallbackData = {};
  const knownKeys = new Set(['id', 'version', 'title', 'date', 'published_at', 'created_at', 'updated_at', 'author', 'reviewed_by', 'category', 'excerpt', 'tags', 'cover_query', 'cover_subject', 'cover_avoid', 'cover_provider', 'cover_provider_id', 'cover_image', 'cover_alt', 'cover_focus', 'cover_score', 'cover_credit', 'cover_credit_url', 'cover_source_url', 'cover_license', 'cover_license_url']);
...
<html lang="de">
  <head>
    ...
    <link rel="stylesheet" href="/assets/css/article-metrics.css?v=20260923-3" />
  </head>
  <body class="post-detail">
    ...
    <script src="/script.js?v=20260922-1"></script>
