...
cover_alt: >-
  ...
  software, speed, delivery, teamwork, art word, plan, to build, continuously,
  feedback, integration, application, apply, control, operate, endless loop,
  loop, gear, arrows, representation, information, software development, symbol,
