...
cover_provider_id: '1990405'
cover_image: /assets/covers/2026-08-27-immich-nextcloud-webdav-rclone-provisionierung.png
cover_alt: >-
  cloud computing, cloud, upload, file, network, backup, storage, internet,
  data, icon, transfer, cloud computing, cloud computing, cloud computing,
  upload, upload, upload, upload, upload, backup, backup, backup
cover_focus: center
cover_credit: by Tumisu via Pixabay
cover_credit_url: 'https://pixabay.com/illustrations/cloud-computing-cloud-upload-file-1990405/'
cover_source_url: 'https://pixabay.com/illustrations/cloud-computing-cloud-upload-file-1990405/'
